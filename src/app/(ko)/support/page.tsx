                ...
                <div className="space-y-4 text-sm">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href="tel:1544-1909" className="text-silver-200 hover:text-accent transition-colors font-medium">
                        1544-1909
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-silver-200 leading-relaxed">경기도 안산시 단원구 번영로 44번길 2</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
